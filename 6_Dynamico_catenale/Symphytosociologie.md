...
<aside> ♻️ A noter que tous les individus des associations végétales d’une tessela sont reliés par un lien dynamique. Cela car les tesselae sont contenues dans un espace de même potentialité écologique.
...
![Untitled](https://prod-files-secure.s3.us-west-2.amazonaws.com/ba957566-fe0e-4199-9015-eb19389d4749/8af43268-d5ce-4d3a-afc7-d46e287188bd/Untitled.png)

On utilise les mêmes coefficients qu’en phytosociologie pour définir l’abondance dominance des individus d’association au sein de la tessela :
...
Il existe également des sous-séries dont la terminaison est **-etosum** (ex : Draboecio cantabricae sigm**etosum).**
...
|_**➡️**Série tempohygrophile_|Il s’agit des séries climatophiles les plus proches de la zone des séries édaphohygrophiles. On va par exemple y retrouver les forêts mésophiles, mais pas les hêtraies qui sont plus en altitude sur le versant.|
...
- **Série ou sigmetum**
    ...
    Ces séries ont plusieurs stades de succession et le stade terminal est forestier.
    
- **Série permanente ou Permasérie ou Permasigmetum**
    
    Séries dont le stade terminale est aussi le stade pionnier. Il n’existe alors qu’un seul syntaxon sur ses séries (ex :pelouses alpines, plages, falaises littoral, mangroves etc…).
    
    De par cette propriété, les tesselae des permaséries sont toujours constitué d’une seule association qui est l’association au stade terminale. On parle alors de **microtessela** et non de tessela.
    
    Les permaséries peuvent avoir un stade annuel avant le stade de vivace stable. Les stades annuels stables sont des **Theroséries** (**Therosigmetum**)
    
- **Cas intermédiaire : Mésosérie**
    
    Séries dont le stade terminal est souvent chaméphytique ou arbustif
    
    - **Minorisérie ou minorisigmetum**
        
        Série dont le stade terminal est maintenu par un **stress** (manque de sol, climat, vent etc…) et dont le stade terminal n’est pas forestier.
        
    - **Curtasérie ou curtasigmetum**
        
        Série dont le stade terminal est entretenu par une **perturbation** régulière (ex couloir d’avalanche, crue etc…). Les curtaséries sont souvent liées au cycle de l’eau et sont des séries édaphohygrophiles.
        

## [Sources et remerciements](https://app.notion.com/p/Sources-et-remerciements-d09e906a6bf0468db66343419687760e?pvs=21)